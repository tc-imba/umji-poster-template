...
\usepackage[size=a1]{beamerposter} % Use the beamerposter package for laying out the poster
...
\newlength{\twocolwid}
\newlength{\threecolwid}
\setlength{\paperwidth}{23.63in} % A0 width: 46.8in
\setlength{\paperheight}{35.44in} % A0 height: 33.1in
...
%\renewcommand*{\Huge}{\fontsize{66pt}{66pt}\selectfont}
\renewcommand*{\huge}{\fontsize{55}{55}\selectfont}
\renewcommand*{\Large}{\fontsize{40}{40}\selectfont}
\renewcommand*{\large}{\fontsize{34}{34}\selectfont}
\renewcommand*{\normalsize}{\fontsize{32}{32}\selectfont}
\renewcommand*{\small}{\fontsize{28}{28}\selectfont}
